...
productModel.addProduct = (req, callback) => {
    let body = req.body;
    let product = {name: body.name, category_id: body.category_id, stock: body.stock, price: body.price, main_photo: body.main_photo, description: body.description, features: body.features, options: body.options, estimated_days_to_deliver_by_seller: body.estimated_days_to_deliver_by_seller};
